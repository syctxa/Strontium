...
module.exports = function(data, keys) {
    ...
    let vm = `("Strontium Obfuscator"):gsub(".+",function(LENGTH,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z)\nreturn( function()\n${numeric_index + build}end)()("${secure_byte}");\nend)`//let vm = `return(function()${funcs.minify(numeric_index + funcs.minify(AST))};end)()("${secure_byte}");`
